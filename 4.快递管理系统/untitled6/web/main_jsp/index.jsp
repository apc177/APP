...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row  border-bottom white-bg dashboard-header">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                        ...
                        <div id="toolbar" >
                            <form class="form-inline" style="width:100%; margin-bottom: 20px;">
                                <div class="form-group" style="margin-left: 5px;">
                                    <input type="button" value="签收" id="get" class="btn btn-danger" onclick="qianshou()">
                                </div>
                                <div class="form-group" style="margin-left: 5px;">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="addAreaForm" class="form-horizontal" action="../editlist"  method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="ramarks" class="col-sm-2 control-label">备注：</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="ramark" id="ramarks" class="form-control">
                                        </div>
                                    </div>
                ...
                <!-- 新增区域模态窗体 -->
                <div class="modal fade" id="dellist" role="dialog" tabindex="-1">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header ">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="reset_Form()"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">你真的要删除吗</h4>
                            </div>
                            <div class="modal-body">

                                <form id="del" class="form-horizontal" action="../editlist"  method="post">
                                    <input type="hidden" name ="id" id="id">
                                </form>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal" onclick="reset_Form()">取消</button>
                                <button type="button" class="btn btn-primary" onclick="deleteArea()">确定</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function addinfo() {
            toastr.success($('#name').val(), $('#passwd').val());
            // var unames=$('#name').val();
            // var pawd=$('#passwd').val();
            var id=$('#areaId').val();
