...
<%--                                    </div>--%>
                                    ...
                                    <%--                                    <div id="sex"  class="el-form-item">--%>
                                    <%--                                        <label class="el-form-item__label"--%>
                                    <%--                                                                     style="width: 60px;">性别</label>--%>
                                    <%--                                        <div class="el-form-item__content" style="margin-left: 60px;">--%>
                                    <%--                                            <div class="el-select allLine el-select--medium"--%>
                                    ...
                                    <%--                                                                <!---->--%>
                                    <%--                                                                <li class="el-select-dropdown__item"><span>女生</span>--%>
                                    <%--                                                                </li>--%>
